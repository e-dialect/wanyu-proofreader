...
| `frontend/public/pdfjs/standard_fonts/**` | Included with PDF.js | Foxit, Google, Red Hat, and identified contributors | Path-specific terms including OFL-1.1 | No license change |
